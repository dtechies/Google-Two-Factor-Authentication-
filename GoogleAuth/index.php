...
<input type="submit" class="button" name="loginSubmit" value="Login" style="float: left;">
<input type="reset" class="button" name="loginReset" value="Reset" style=" float: left; margin-left: 18px;">
</form>
</div>
...
<input type="reset" class="button" name="loginReset" value="Reset" style=" float: left;">
<input type="submit" class="button" name="signupSubmit" value="Signup"style="float: left;  margin-left: 18px;">
